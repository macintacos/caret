...
logging, TypeScript, Svelte, testing, icons, settings, OpenCode). They are the substance
behind `CLAUDE.md`'s routing digraph; each is concise and scoped to its own area.
