...
`README.md` (the comprehensive guide) and `doc/agents/` (the rules-of-the-road) for depth.
Don't let it grow into a second README.
...
live in `README.md`. Never put secrets or secret-shaped values in this file.
