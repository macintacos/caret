...
export const uiLog = {
	debug: (step: string, msg: string, extra?: object) =>
		emit("debug", step, msg, extra),
	info: (step: string, msg: string, extra?: object) =>
		emit("info", step, msg, extra),
	warn: (step: string, msg: string, extra?: object) =>
		emit("warn", step, msg, extra),
