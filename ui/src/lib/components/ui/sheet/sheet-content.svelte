...
<script lang="ts">
	...
	// stock `@lucide/svelte/icons/x` import is replaced by the inlined Lucide "x"
	// close glyph below (the same markup dialog-content.svelte uses), so this
	// vendored tree stays self-contained and adds no icon runtime dependency.
