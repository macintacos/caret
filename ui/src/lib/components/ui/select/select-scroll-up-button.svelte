<script lang="ts">
	...
	// decision). The stock `@lucide/svelte/icons/chevron-up` import is replaced by the
	// vendored glyph through Icon.svelte; the button is already the flex wrapper, so
	// Icon needs no <span> of its own here.
