...
//
// It is written to be a no-op on a fixed JSC — the rewritten form is correct
// everywhere — so the module can simply be deleted if the engine is ever repaired.
//
...
// comment in the diff view mistokenized for Safari reviewers, and silently.
//
...
// INVERTED — a red means the fix landed upstream, the point to start checking
// whether the Safari versions caret still serves carry it, not the point to delete
// this module (EXC-1223).
