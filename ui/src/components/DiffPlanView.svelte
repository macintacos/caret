...
<style>
  ...
  .control-row {
    ...
    /* As a .shell flex item this row defaults to min-width:auto, which floors it
       ...
       lets the row shrink so the .cwd's own overflow:ellipsis takes over,
       matching the topbar's min-width:0 fix (EXC-810/EXC-814). */
    min-width: 0;
  }
