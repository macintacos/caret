 ...
 * overrides them) and ensureDaemon's supervisor window (`windowMs`, about 14s from the
 * call's start), which a cycled service's successor and the re-post after a 503 both
 * have to arrive inside. */
